...
```bash
bash <(curl -Ls https://github.com/mahyyar/backup/raw/main/backup.sh)
``` 
...
[![Stargazers over time](https://starchart.cc/mahyyar/backup.svg)](https://starchart.cc/mahyyar/backup)
